                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="timedate.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>Voting Name</b></label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="Description"><b>Date - Time </b></label>
                                            <div class="controls">
                                                
                                                <input type="datetime-local" name="event_dt" class="span8" required>
                                            </div>
                                        </div>
                        ...
                        <center>
                                <a href="viewNDT.php" class="btn btn-success">view Name&Dt</a></center>
...
$sql1="insert into timedate (name,eventdt) VALUES ('$name','$event_dt')"; 
