            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <?php
                            $x=$_GET['id'];
                            $sql="select * from user where mobile ='$x'";
                            $result=$connect->query($sql);
                            $row=$result->fetch_assoc();    
                            
                                $bookid=$row['mobile'];
                                $name=$row['name'];
                                $publisher=$row['address'];
                                $photo =$row['photo2'];

                                ?>
                                
                                <center><img src=" uploads/<?php echo $photo ?>" height="500" width="500"></center><br>
                                <?php
                                echo "<br> <br>";  

                                echo "<b>Voter NID:</b> " .$bookid. "<br><br>";
                                echo "<b>Name:</b> ".$name."<br><br>";
                                
                               
                                echo "<b>Address:</b> ".$publisher."<br><br>";
                            ?>
                        ...
                        <a href="votar.php" class="btn btn-primary">Go Back</a>                             
                               </div>
                           </div>
                            </div>
                    <!--/.span3-->
